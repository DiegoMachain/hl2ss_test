...
class DittoManager():
    ...
    def new_position(self, req):
        ...
        if self.sendFlag:
            ...
            #r = R.from_quat([self.data_to_send.data[0], self.data_to_send.data[1],self.data_to_send.data[2],self.data_to_send.data[3]])
            #rotation = r.as_euler('zxy', degrees=True)

            #print("Euler angles = ", r.as_euler('zxy', degrees=True))
            #'zxy'
